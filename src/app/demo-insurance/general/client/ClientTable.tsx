...
import { Client, getClientColumnDefinitions } from './Client.model';
...
*/
  ...
  const columnDefinitions: ColumnDefinition[] = getClientColumnDefinitions();
...
const rightContents = (
    <React.Fragment>
      {displayedMessages !== undefined && displayedMessages.length > 0 &&
        <Button className="p-button-rounded p-button-danger p-button-text p-button-lg" icon="pi pi-exclamation-triangle" onClick={() => {toastMessages(displayedMessages)}} /> }
    </React.Fragment>
);
